...
- `app-templates/archify/TEMPLATE.md` /
  `app-templates/install_booking_agent/TEMPLATE.md` — the two exemplars
  as template entries (agent + repair loop; FSM guided conversation).
